...
class TwitterSearchImpl(TwitterSearch):
    ...
    def __init__(self,projectname, rate_delay, error_delay, max_tweets):
        ...
        self.counter = 0
        self.projeckDir=path.datapath+'webpagefortwitter/News/'+self.projectname+'/'
...
if __name__ == '__main__':
    checkedlist=list()
    try:
        with open(  path.datapath+"checkedNewsInNewsLIST.txt", mode='r') as Seenlist2:
            for sentence in   Seenlist2:
                checkedlist.append(sentence.replace('\n',''))
    except FileNotFoundError:
         with open(path.datapath +'checkedNewsInNewsLIST.txt', encoding='utf-8', mode='a') as Seenlist:
             Seenlist.write('')
    ...
    with open(  path.datapath+"NewsLIST.txt",encoding="utf-8", mode='r') as Seenlist:
        for sentence in Seenlist:
            ...
            if(checkedtitle not in checkedlist):
                ...
                with open(  path.datapath+"checkedNewsInNewsLIST.txt", mode='a') as Seenlist2:
