...
if __name__ == "__main__":
    with open('/Users/licheng5625/PythonCode/masterarbeit/snopesCrawler/webpages/20160418mcdonalds-testing-all-you-can-eat-french-fries-and-ordering-kiosks.html', encoding='utf-8', mode='r') as Seenlist:

        print (html2text(Seenlist.read()))
